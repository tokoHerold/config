...
-- Args: capture, option, keybind
wk.add({ "<leader>d", desc = "Peek definition..." })
to.add_lsp_bind("@function.outer", "peek_definition_code", "<leader>dF")
to.add_lsp_bind("@function.inner", "peek_definition_code", "<leader>df")
to.add_lsp_bind("@class.outer", "peek_definition_code", "<leader>dC")
to.add_lsp_bind("@class.inner", "peek_definition_code", "<leader>dc")
to.setup()
...
set("n", "<leader>isa", iron.send_until_cursor, { desc = "Send above" })
...
set('n', "<leader>ue", dapui.eval, { desc = "Evaluate Expr." })
...
set('n', "<leader>ur", dap.run_last, { desc = "Re-run" })
set('n', "<leader>ux", dap.terminate, { desc = "Terminate" })
set('n', "<F5>", function() step_and_center(dap.continue) end, { desc = "Continue" })
set('n', "<F9>", function() step_and_center(dap.step_over) end, { desc = "Step over" })
set('n', "<F10>", function() step_and_center(dap.step_into) end, { desc = "Step into" })
set('n', "<F11>", function() step_and_center(dap.step_out) end, { desc = "Step out" })
set('n', "<F12>", function() step_and_center(dap.run_to_cursor) end, { desc = "Run to Cursor" })
